...
public final class ArmorEquipEvent extends PlayerEvent implements Cancellable{
    ...
    private final ArmorListener.ArmorType type;
     ...
     */
    public ArmorEquipEvent(final Player player, final EquipMethod equipType, final ArmorListener.ArmorType type, final ItemStack oldArmorPiece, final ItemStack newArmorPiece){
        super(player);
    ...
    public final ArmorListener.ArmorType getType(){
        return type;
    }
