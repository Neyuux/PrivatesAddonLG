package fr.neyuux.privatesaddonlg.utils;
...
public class Reflection {
    ...
    public static void playSound(@NonNull Player player, @NonNull Location location, @NonNull String soundName, float volume, float pitch) {
        try {
    ...
    public static @Nullable Class<?> getOBCClass(String className) {
        try {
    ...
    public static @Nullable Method makeMethod(Class<?> clazz, String methodName, Class<?>... paramaters) {
        try {
